; final_demo.asm
; Final assembly code to showcase our Brightness Control Peripheral
; Code designed for implementation on the DE10 board.
; Contains multiple code bl
; Sanat Dhanyamraju, Connor Smith, and Thomas Becker
; ECE 2031 L8
; Created 03/6/2025
...
All10Down: ; 
	...
	IN 		Switches
	SUB Bit9
	JZERO Bit9Startup ; basically if only switch 9 is high
	
	IN 		Switches
	SUB Bit8
	JZERO Bit8Startup ; basically if only switch 8 is high
	
	IN 		Switches
	SUB Bit7
	JZERO ResetBrightness ; basically if only switch 7 is high
	
	JUMP All10Down ; else wait
; ------- End Code Block ----------


; ------ Bit9Startup VECTOR Demo Code subroutine ----
Bit9Startup:
    LOADI   0 ; load value 
...
; ------ Bit8Startup Demo WAVE Code subroutine ----
Bit8Startup:
...
; ------ Bit7Startup Demo GLOW Code subroutine ----
ResetBrightness:
	LOADI 0
...
; ------ TIMER 5 second Delay DEFAULT SUBROUTINE ------
DELAY:
